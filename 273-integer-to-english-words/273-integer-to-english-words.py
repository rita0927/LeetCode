...
#                 return d[n]
#             elif n < 100:
#                 return d[n//10 * 10] + ' ' + helper(n%10) if n%10 else d[n//10 * 10]
#             elif n < 1000:
#                 return d[n//100] + ' Hundred ' + helper(n%100) if n % 100 else d[n//100 * 100] + ' Hundred '
...
#         if num > 1000000000:
#             count, num = divmod(num,1000000000)
#             res.append(count)
#             res.append(d[1000000000])
#         if num > 1000000:
#             count, num = divmod(num, 1000000)
#             res.append(helper(count))
#             res.append(d[1000000])
#         if num > 1000:
#             count, num = divmod(num, 1000)
#             res.append(helper(count))
#             res.append(d[1000])
#         if num > 0:
#             res.append(helper(num))
